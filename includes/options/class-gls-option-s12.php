...
class GLS_Option_S12 extends GLS_Delivery_Option
{
    /**
    ...
    {
        $this->id                 = 'gls_s12';
        $this->method_title       = __('TimeDefiniteService (Saturday before 12.00 AM)', 'gls-woocommerce');
        $this->method_description = __('Delivery on Saturday before 12.00 AM.', 'gls-woocommerce');
