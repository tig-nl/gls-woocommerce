...
class GLS_Option_T17 extends GLS_Delivery_Option
{
    /**
    ...
    {
        $this->id                 = 'gls_t17';
        $this->method_title       = __('TimeDefiniteService (Before 17.00 AM)', 'gls-woocommerce');
        $this->method_description = __('Next business day delivery before 17.00 AM.', 'gls-woocommerce');
